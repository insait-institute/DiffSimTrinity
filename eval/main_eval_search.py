...
parser.add_argument('--num_envs', '-envs', type=int, help='How many environments for batched evaluation', default=30)
...
parser.add_argument('--do_search', '-s', type=int, help='Whether to use do search', default=False)
