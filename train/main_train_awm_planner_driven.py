...
from train.trainer_awm import Trainer
...
from configs.conf_train_awm_planner_driven import config

# Ckeckpoint path
current_time = datetime.now()
date_string = current_time.strftime("%Y%m%d_%H%M%S")
log_folder = f"logs/{date_string}"
log_folder = f"logs/train_awm_planner_driven"
...
# Environment config
assert config['env_type'] == 'planning'
